...
const ViewEmployee: React.FC<ViewEmployeeProps> = ({ employeeId, initialData }) => {
  const handleViewClick = () => {
    // Use Next.js router to navigate to the employee details page with query parameters
    window.location.href = `/notes/${employeeId}?firstName=${initialData.firstName}&lastName=${initialData.lastName}&job=${initialData.job}&email=${initialData.email}`;
  };
